   ...
   <div class="col-md-12 column">
    <div class="col-md-10 column">
     ...
     <div class="col-md-1 column">
       <Button type="error" v-on:click="updateDraft" long ghost style="height: 50px;">保存草稿</Button>
     </div>
     <div class="col-md-1 column">
      <Button type="error" v-on:click="articleShowClick" long style="height: 50px;">发布文章</Button>
      <el-drawer
        ...
        <Form :label-width="80">
          <FormItem>
            <div style="border-bottom: 1px solid #e9e9e9;padding-bottom:6px;margin-bottom:6px;">
              <Strong><p align="center" style="color: black">发布文章</p></Strong>
            </div>
            <el-popover
              placement="right"
              width="400"
          ...
          <FormItem label="文章保密">
            <RadioGroup v-model="articleSecurity">
              ...
              <Radio label="vip"  v-if="articleType!=='forward' && memberSign!=='0' && memberSign!==null " border>会员</Radio>
            </RadioGroup>
          </FormItem>
          <FormItem>
            ...
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <Button type="error" @click="articleShow=false" v-on:click="articlePublish">发布文章</Button>
          </FormItem>
        </Form>
      </el-drawer>
    </div>
...
<script>
    ...
    const articleTagAll=['测试','运维','前端','后端','全栈','架构','C语言','CPlus','Java','PHP','Python','Go','大数据',
        ...
        methods: {
            ...
            updateDraft(){
                if (this.articleTitle ==='' || this.articleContent === '' ||  this.articleTitle.match(/^[ ]*$/)
                    ...
                    this.$http.post('/whc/blog-customer-user/insertDraftFeign', {
            ...
            //查询数据库中的文章草稿箱
            selectDraft(){
                this.$http.post('/whc/blog-customer-user/selectDraftFeign')
                    .then(res => {
                        if (res.data.success===true){
                            this.articleTitle=res.data.articleTitle;
                            this.articleContent=res.data.articleContent;
            ...
            articlePublish(){
                ...
                if (this.articleTitle === '' || this.articleContent === '' || this.articleTag === '' ||
                    ...
                    this.$http.post('/whc/blog-customer-user/articlePublishFeign', {
                        articleTitle: this.articleTitle,
                        articleContent: this.articleContent,
